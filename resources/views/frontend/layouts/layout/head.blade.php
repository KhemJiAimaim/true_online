...
<nav class="bg-gradient-to-r from-red-600 via-pink-700 to-blue-500"">
    ...
    <div class="mobile-menu hidden md:hidden bg-white">
        <a href="" class="block py-2 px-4 text-sm hover:bg-gray-200">อินเตอร์เน็ตไฟเบอร์</a>
        <a href="" class="block py-2 px-4 text-sm hover:bg-gray-200">เบอร์มงคลรายเดือน</span>
            <a href="" class="block py-2 px-4 text-sm hover:bg-gray-200">เติมเงิน</a>
            <a href="" class="block py-2 px-4 text-sm hover:bg-gray-200">ซิมท่องเที่ยว</a>
            <a href="" class="block py-2 px-4 text-sm hover:bg-gray-200">วิธีการสั่งซื้อ</a>

</nav>

<div class="hidden md:flex w-3/4 px-8 mx-auto mt-4 mb-4 ">
    <div class="hidden md:flex flex justify-start space-x-32 text-sm font-bold">
        <div class="">
            <span>อินเตอร์เน็ตไฟเบอร์</span>
        </div>
        <div class="">
            <span>เบอร์มงคลรายเดือน</span>
        </div>
        <div class="">
            <span>เติมเงิน</span>
        </div>
        <div class="">
            <span>ซิมท่องเที่ยว</span>
        </div>
        <div class="">
