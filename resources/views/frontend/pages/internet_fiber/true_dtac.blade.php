...
{{-- @dd($current_cate) --}}
        <section id="fiber" class="py-10  z-0 px-3">
            ...
            <div class="2xl:my-16 my-6 z-2">
                <div
                    class="max-w-[1536px] max-w-[1536px] grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-4 mx-auto py-12 gap-4 gap-y-6 px-4">
