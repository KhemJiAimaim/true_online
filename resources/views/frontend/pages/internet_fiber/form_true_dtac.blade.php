...
@section('style')
    ...
    <script>
        ...
        function selectLo() {
            if (currentMarker) {
                let customer_location = currentMarker.getPosition().lat().toString() + ',' + currentMarker.getPosition()
                    .lng().toString();
    ...
    <div class="">
        <div class="mt-[15%] 2xl:mt-[10%] max-xx:mt-[20%] max-xs:mt-[30%] mx-3 ">
            ...
            <div class="max-w-[1000px] bg-[#F8F9FA] rounded-lg mx-auto p-2 2xl:mt-10 mt-6 py-4 px-4">
                ...
                <div
                    class="grid 2xl:grid-cols-2 xl:grid-cols-2 lg:grid-cols-2 dm:grid-cols-2 md:grid-cols-2 gap-y-4 items-center mt-4">
                    <div class="flex justify-between items-center">
                        <label for="phone"
                    ...
                    <div class="flex justify-between items-center">
                        <label for="line-id"
                            class="w-32  text-right max-ex:text-left pr-4 font-medium text-gray-700">ไลน์ไอดี
                            (ถ้ามี)</label>
                        <div class="flex-1">
                ...
                <div
                    ...
                    <div
                        ...
                        <select id="province" name="province"
                            class="max-2xl:w-[22rem] max-xs:w-[16rem] ex:w-[24rem] dm:w-[20rem] lg:w-[23rem] md:w-[17rem] es:w-[15.5rem] ss:w-[13rem] se:w-[12rem] focus:outline-none focus:ring-2 focus:ring-sky-600  text-gray-700 py-2 px-3 border border-gray-300 bg-white rounded-md">
                ...
                <div class="flex 2xl:justify-between max-ex:flex-col 2xl:items-start gap-y-2 mt-4">
                    ...
                    <div class="flex flex-col gap-4 flex-1">
                        <div class="relative">
                            <input required type="text" id="input-pin"
                                class="w-full rounded-md appearance-none border border-gray-300 py-2 px-2 bg-white text-gray-700 placeholder-gray-400 shadow-sm focus:outline-none focus:ring-2 focus:ring-sky-600 focus:border-transparent"
                                placeholder="16.408917,102.773789">
                            <button id="pin_address"
                                class="bg-gray-300 p-1 rounded-full absolute right-0 top-[50%] translate-x-[-50%] translate-y-[-50%]"><img
                                    src="/icons/addressicon.png" alt=""></button>
                        </div>
                        <iframe id="show-map" class="w-full rounded-lg hidden" height="250" style="border:0;"
                            allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" src=""
                ...
                <p class="text-[1rem] text-[#838383] 2xl:mt-6 mt-10">ท่านจะได้รับการติดต่อกลับจากเจ้าหน้าที่ ภายใน 30 นาที
                </p>
            </div>
        </div>
