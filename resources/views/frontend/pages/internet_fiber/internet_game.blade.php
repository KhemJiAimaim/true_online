    ...
    <div class="my-16">
        ...
        <section class="py-6">
            <div class="py-6">
                ...
                <p class="text-[#838383] mt-2 mb-2 text-[18px]">ลดปิง แยกแบนด์วิดท์ เล่นหรือสตรีมเกม ไม่มีแลค</p>
            </div>
                ...
                <div class="max-w-[1536px] grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-4 gap-4 m-auto p-4 ">
                    ...
                    <div class="drop-shadow-md">
                        <div
                            ...
                            <p class="text-white text-left text-[1rem]">True Gigatex PRO Gamer</p>
                        ...
                        <div class="bg-[#F8F9FA]">
                            <div class="">
                                <p class="py-3">True Gigatex PRO Gamer 2Gbps</p>
                            </div>
                        </div>
                        <div class="bg-white"">
                            ...
                            <div class="flex justify-center py-6">
                                <img class="w-35" src="/images/Rectangle 235.png" alt="">
                                <div class="border-l border border-gray-500 text-center mx-3 rounded-full"></div>
                                <img class="w-35" src="/images/Rectangle 234.png" alt="">
                            </div>
                        </div>
                        ...
                        <div class=" relative bg-gradient-to-r from-[#5642CD] to-[#00BCFF]   py-3 px-2">
                            ...
                            <div class="grid grid-cols-3">
                                ...
                                <p class="text-white font-medium text-center text-3xl pt-3">1,190</p>
                        ...
                        <div class="bg-white rounded-bl-[10px] rounded-br-[10px] flex justify-center">
                            <a href="/fiber/detail_internet_game"
                    ...
                    <div class="drop-shadow-md">
                        ...
                        <div class="bg-[#F8F9FA]">
                            <div class="">
                                <p class="py-3">True Gigatex PRO Gamer 1.5Gbpss</p>
                            </div>
                        </div>
                        <div class="bg-white"">
                            <div class="flex justify-center py-6 ml-12">
                                <p class="text-3xl text-center">1.5</p>
                                <div class="border-l border border-gray-500 text-center mx-6 rounded-full"></div>
                                <p class="text-md text-left text-md">Gbps<br>/500Mbps</p>
                            </div>
                        ...
                        <div class=" relative bg-gradient-to-r from-[#5642CD] to-[#00BCFF]   py-3 px-2">
                            ...
                            <div class="grid grid-cols-3">
                                <p class="text-white text-left text-[1rem]  pt-3">ราคา</p>
                                <p class="text-white font-medium text-center text-3xl pt-3">999</p>
                                <p class="text-white text-right text-[1rem] ">บาท<br>/เดือน</p>
                    ...
                    <div class="drop-shadow-md">
                        <div
                            ...
                            <p class="text-white text-left text-[1rem]">True Gigatex PRO Gamer 999</p>
                            {{-- <img class="bg-imag-head" src="/images/Intersect2.png" alt=""> --}}
                            <img class="absolute top-0 right-0" src="/images/Intersect2.png" alt="">
                        </div>
                    ...
                    <div class="drop-shadow-md">
                        ...
                        <div class="bg-[#F8F9FA]">
                            <div class="">
                                <p class="py-3">True Gigatex PRO Gamer 899</p>
                            </div>
                        </div>
                        <div class="bg-white"">
                            <div class="flex justify-center py-6 ml-12">
                                <p class="text-3xl text-center">300</p>
                                <div class="border-l border border-gray-500 text-center mx-6 rounded-full"></div>
                                <p class="text-md text-left text-md">Gbps<br>/500Mbps</p>
                            </div>
                        ...
                        <div class=" relative bg-gradient-to-r from-[#5642CD] to-[#00BCFF]   py-3 px-2">
                            ...
                            <div class="grid grid-cols-3">
                                <p class="text-white text-left text-[1rem]  pt-3">ราคา</p>
                                <p class="text-white font-medium text-center text-3xl pt-3">899</p>
                                <p class="text-white text-right text-[1rem] ">บาท<br>/เดือน</p>
