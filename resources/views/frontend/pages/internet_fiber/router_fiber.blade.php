    ...
    <div class="my-16">
        ...
        <section class="py-6">
            <div class="py-6">
                ...
                <p class="text-[#838383] mt-2 mb-2 text-[18px]">ทางเลือกสุดคุ้ม นำเราเตอร์ของคุณเองมาใช้ ร่วมกับแพ็กเกจเน็ตบ้านทรู ราคาสุดพิเศษ</p>
            </div>
                ...
                <div class="max-w-[1536px]  grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-4 gap-4 m-auto p-4 ">
                    <div class="drop-shadow-md col-start-2">
                        <div
                            ...
                            <p class="text-white text-left text-[1rem]">True Gigatex PRO CYOD</p>
                        ...
                        <div class="bg-[#F8F9FA]">
                            <div class="">
                                <p class="py-3">True Gigatex PRO CYOD 999</p>
                            </div>
                        </div>
                        <div class="bg-white"">
                            ...
                            <div class="flex justify-center py-6">
                                <img class="w-35" src="/images/Rectangle 397.png" alt="">
                                <div class="border-l border border-gray-500 text-center mx-3 rounded-full"></div>
                                <img class="w-35" src="/images/Rectangle 398.png" alt="">
                            </div>
                        </div>
                        ...
                        <div class="bg-white rounded-bl-[10px] rounded-br-[10px] flex justify-center">
                            <a href="/fiber/detail_router_fiber"
                    ...
                    <div class="drop-shadow-md">
                        ...
                        <div class="bg-[#F8F9FA]">
                            <div class="">
                                <p class="py-3">True Gigatex PRO CYOD 599</p>
                            </div>
                        </div>
                        <div class="bg-white"">
                            <div class="flex justify-center py-6 ml-12">
                            ...
                            <div class="flex justify-center py-6">
                                <img class="w-35" src="/images/Rectangle 399.png" alt="">
                                <div class="border-l border border-gray-500 text-center mx-3 rounded-full"></div>
                                <img class="w-35" src="/images/Rectangle 398.png" alt="">
                            </div>
                        </div>
                        ...
                        <div class="bg-gradient-to-r from-[#5642CD] to-[#00BCFF]   py-3 px-2">
                            <div class="grid grid-cols-3">
                                <p class="text-white text-left text-[1rem]  pt-3">ราคา</p>
                                <p class="text-white font-medium text-center text-3xl pt-3">599</p>
                                <p class="text-white text-right text-[1rem] ">บาท<br>/เดือน</p>
