    ...
    <div class="py-16">
        ...
        <section class="py-6">
            <div class="py-6">
                ...
                <p class="text-[#838383] mt-2 mb-2 text-[18px]">ครบกว่า คุ้มกว่า แรงกว่าทุกกระแส ดูเต็มอิ่ม หนัง กีฬา ความบันเทิง</p>
            </div>
                ...
                <div class="max-w-[1536px] grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-4 gap-4 m-auto p-4 ">
                    ...
                    <div class="drop-shadow-md">
                        <div
                            ...
                            <p class="text-white text-left text-[1rem]">แพ็กเกจแนะนำ</p>
                        ...
                        <div class="bg-[#F8F9FA]">
                            <div class="">
                                <p class="py-3">True Gigatex PRO</p>
                            </div>
                        </div>
                        <div class="bg-white"">
                        ...
                        <div class="bg-white rounded-bl-[10px] rounded-br-[10px] flex justify-center">
                            <a href="/fiber/detail_internet_basic"
