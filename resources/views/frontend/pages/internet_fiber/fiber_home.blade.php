...
@section('content')
    <div class="2xl:mt-16">
        ...
        <section id="fiber" class="py-6  z-0 px-3">
        ...
        <section id="fiber" class=" py-6  z-0 px-3">
            ...
            {{-- <img class=" absolute right-0 top-0 z-[-1]" src="/images/circle/ci1.png" alt=""> --}}
            <p class="text-[#000] mt-2 mb-2 2xl:text-[2rem]  xl:text-[22px] text-[20px] font-medium">True Gigatex PRO</p>
            <p class="text-[#838383] mt-2 mb-2 2xl:text-[20px]  xl:text-[18px] text-[16px]">ครบกว่า คุ้มกว่า แรงกว่าทุกกระแส ดูเต็มอิ่ม หนัง กีฬา ความบันเทิง</p>
        ...
        <section id="fiber" class=" py-6  z-0 px-3">
            ...
            {{-- <img class=" absolute right-0 top-0 z-[-1]" src="/images/circle/ci1.png" alt=""> --}}
            <p class="text-[#000] mt-2 mb-2 2xl:text-[2rem]  xl:text-[22px] text-[20px] font-medium">True Gigatex PRO Security</p>
            <p class="text-[#838383] mt-2 mb-2 2xl:text-[20px]  xl:text-[18px] text-[16px]">แพ็กเกจเน็ตบ้าน ครอบคลุมทุกย่าน ด้วยความห่วงใย</p>
        ...
        <section id="fiber" class=" py-6  z-0 px-3">
            ...
            {{-- <img class=" absolute right-0 top-0 z-[-1]" src="/images/circle/ci1.png" alt=""> --}}
            <p class="text-[#000] mt-2 mb-2 2xl:text-[2rem]  xl:text-[22px] text-[20px] font-medium">True Gigatex PRO CYOD</p>
            <p class="text-[#838383] mt-2 mb-2 2xl:text-[20px]  xl:text-[18px] text-[16px]">ทางเลือกสุดคุ้ม นำเราเตอร์ของคุณเองมาใช้ ร่วมกับแพ็กเกจเน็ตบ้านทรู ราคาสุดพิเศษ</p>
        ...
        <section id="fiber" class=" py-6  z-0 px-3">
            ...
            {{-- <img class=" absolute right-0 top-0 z-[-1]" src="/images/circle/ci1.png" alt=""> --}}
            <p class="text-[#000] mt-2 mb-2 2xl:text-[2rem]  xl:text-[22px] text-[20px] font-medium">True Gigatex PRO Gold</p>
            <p class="text-[#838383] mt-2 mb-2 2xl:text-[20px]  xl:text-[18px] text-[16px]">กล่องทรูไฮบริด พร้อมคอนเทนท์พรีเมียม | สตรีมมิง | แอพสุดฮิต มาพร้อมเน็ตบ้านไฟเบอร์ทรู 1Gbps</p>
        ...
        <section id="fiber" class=" py-6  z-0 px-3">
            ...
            {{-- <img class=" absolute right-0 top-0 z-[-1]" src="/images/circle/ci1.png" alt=""> --}}
            <p class="text-[#000] mt-2 mb-2 2xl:text-[2rem]  xl:text-[22px] text-[20px] font-medium">True Gigatex PRO Gamer</p>
            <p class="text-[#838383] mt-2 mb-2 2xl:text-[20px]  xl:text-[18px] text-[16px]">แพ็กเกจเน็ตบ้าน ครอบคลุมทุกย่าน ด้วยความห่วงใย</p>
        ...
        <section id="fiber" class="bg-gray-100 py-6 relative z-0 px-3">
            ...
            <img class=" absolute right-0 top-0 z-[-1]" src="/images/circle/ci1.png" alt="">
            <p class="text-[#000] mt-2 mb-2 2xl:text-[2rem]  xl:text-[22px] text-[20px] font-medium">True Gigatex PRO SME</p>
            <p class="text-[#838383] mt-2 mb-2 2xl:text-[20px]  xl:text-[18px] text-[16px]">เน็ตเร็ว แรง เพื่อธุรกิจ ฟรีค่าโทร พร้อมบริการ Public Fixed IP กับ True Gigatex PRO SME</p>
