            ...
            <div class="w-[1536px] max-2xl:max-w-[90%] grid grid-cols-1 lg:grid-cols-3 2xl:grid-cols-3  gap-4 m-3">
                ...
                <div class="bg-white w-full 2xl:h-[500px]  items-center px-4 lg:px-1 mb-6 relative">
                    ...
                    <div id="slide-wrapper" class="flex items-center">
                        ...
                        <div id="slider" class="flex gap-4 overflow-x-hidden mx-4 ">
                            <img src="/images/Rectangle1282.png" alt="" class="thumnail active w-[100px] h-[100px] cursor-pointer rounded-lg opacity-50 hover:opacity-100 ">
                            {{-- @for ($i = 1; $i <= 4; $i++)
                                <img src="/images/Rectangle1282.png" alt="" class="thumnail   w-[100px] h-[100px] cursor-pointer rounded-lg opacity-50 hover:opacity-100">
                            @endfor --}}
                ...
                <div class="col-span-2 space-y-6 text-left mx-3">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 2xl:grid-cols-4 gap-2 2xl:gap-4 overflow-auto 2xl:h-[380px] h-[280px] w-full">
                        <div id="box" class="box border border-gray-10 hover:border-gray-500 bg-[#F8F9FA] rounded-lg px-2 py-2 max-ex:h-[8rem] h-[9rem] cursor-pointer">
                            <div class="flex mb-2 ">
                                <img src="/images/Rectangle1282.png" alt="" class="w-20 max-ex:w-[70px] rounded-lg">
                                <p class="text-lg font-medium ml-3 ">{{$move_product->details}}</p>
                            </div>
                            <div class="flex items-center">
                                <img src="/images/check-one.png" alt="" class="check-box w-10 max-ex:w-[35px] ">

                                <p
                                    class="text-xl 2xl:text-[2rem] font-bold ml-[3.5rem] max-ex:ml-[2.5rem] text-red-600">{{$move_product->price}}</p>
                        ...
                        {{-- @foreach ($package_option as $option)
                            @php 
                                ...
                                // dd($option)
                            @endphp
                            <div id="box" data-option="{{$array_opt[1]}}" class="box border border-gray-10 hover:border-gray-500 bg-[#F8F9FA] rounded-lg px-2 py-2 max-ex:h-[8rem] h-[9rem] cursor-pointer">
                                <div class="flex mb-2 ">
                                    <img src="/images/Rectangle1282.png" alt="" class="w-20 max-ex:w-[70px] rounded-lg">
