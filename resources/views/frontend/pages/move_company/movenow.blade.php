    ...
    <div class="2xl:mt-16 mt-[5rem]">
        <div class=" flex justify-center items-center">
            <div class="w-[1536px] max-2xl:max-w-[90%] grid grid-cols-1 lg:grid-cols-3 2xl:grid-cols-3  gap-4 m-3">
                ...
                <div class="bg-white w-full 2xl:h-[500px]  items-center px-4 lg:px-1 mb-6 relative">
                    ...
                    <div id="slide-wrapper" class="flex items-center">
                        ...
                        <div id="slider" class="flex justify-center gap-4 overflow-x-hidden mx-4 ">
                            @for ($i = 1; $i <= 4; $i++) 
                        ...
                        @for ($i = 1; $i <= 8; $i++)
                            <div id="box{{ $i }}"
                                ...
                                <div class="flex items-center">
                                    ...
                                    <p class="text-xl 2xl:text-[2rem] font-bold ml-[3.5rem] max-ex:ml-[2.5rem] text-red-600">150 </p>
         ...
         <div class="w-[1536px] max-2xl:max-w-[90%] pt-6 mx-auto mb-6">
                ...
                {{-- content detail --}}
                <div id="box-package"
                    class="h-[300px] overflow-hidden bg-[#F8F9FA] border-solid border-2 border-[#ED4312] rounded-r-[10px] rounded-bl-[10px]">
                    <div class="flex justify-center p-10">
                    <img src="/images/Rectangle 1669.png" alt="" class="w-[800px]">
                    </div>
                    <div class="w-full lg:w-[400px] ml-3 text-left">
                        <p class="text-[16px] font-medium mt-3">ซิมเทพ เล่นเน็ตไม่อั้น +โทรฟรีทุกค่าย ลูกค้าจะได้เล่นเน็ตไม่จำกัด ฟรีเดือนแรก โปรโมชั่นเครือข่าย True
                        </p>

                        <ol class="mx-6">
                            <li  class="text-[16px]">True ความเร็ว 10Mbps (ไม่ลดสปีด) "ฟรีเดือนแรก" เดือนต่อไป เติมเงิน 210 บาท (รวมภาษีแล้ว)</li>
                            <li class="text-[16px]" >True ความเร็ว 20Mbps (ไม่มีโทรฟรี) เล่นเน็ตไม่อั้น 70GB (FUP 1Mbps) "ฟรีเดือนแรก" เดือนต่อไป เติมเงิน 200 บาท (รวมภาษีแล้ว)</li>
                            <li class="text-[16px]" >True ความเร็ว 15Mbps +โทรฟรีทุกค่าย เล่นเน็ตไม่อั้น 80GB (FUP 1Mbps) "ฟรีเดือนแรก" เดือนต่อไป เติมเงิน 300 บาท (รวมภาษีแล้ว)</li>
                            <li class="text-[16px]" >True ความเร็ว 15Mbps +โทรฟรีทุกค่าย เล่นเน็ตไม่อั้น 55GB (FUP 1Mbps) "ฟรีเดือนแรก" เดือนต่อไป เติมเงิน 250 บาท (รวมภาษีแล้ว)</li>
                            <li class="text-[16px]" >True ความเร็ว 15Mbps +โทรฟรีทุกค่าย เล่นเน็ตไม่อั้น 30GB (FUP 384Kbps) "ฟรีเดือนแรก" เดือนต่อไป เติมเงิน 200 บาท (รวมภาษีแล้ว)</li>
                            <li class="text-[16px]" >True ความเร็ว 4Mbps (ไม่มีโทรฟรี) เล่นเน็ตไม่อั้น 30GB (FUP 1Mbps) "ฟรีเดือนแรก" เดือนต่อไป เติมเงิน 150 บาท (รวมภาษีแล้ว)</li>
                        </ol>
                        <p class="text-[16px]">** ทำไมถึงต้องเลือกทรู ตอบ เล่นได้ทุกแอพ เน็ตไม่มีหมด 8 แอพดังนี้ เล่นโซเชียล Facebook, Line, instagram, TikTok</p>
