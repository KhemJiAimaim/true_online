    ...
    <div class="my-36">
        ...
        <section class="bg-white py-6">
            ...
            <div class=" my-16 w-full">
                <div class="max-w-[1536px] my-0 mx-auto flex justify-center ">

                    <div class="drop-shadow-md w-[424px] ">
                        ...
                        <div class="bg-white flex items-center justify-center flex-col p-4 gap-4  ">
                            ...
                            <div class="flex justify-center items-baseline gap-10">
                                <p class="text-[25px]">เน็ต</p>
                                <p class="text-[76px] text-[#F98E24] ">70</p>
                                <p class="text-[25px]">GB</p>

                            </div>
                            <div class="h-[1px] w-[90%] bg-gray-500 "></div>
                            <div class="flex justify-center items-baseline gap-10">
                                <p class="text-[25px]">เน็ต</p>
                                <p class="text-[76px] text-[#F98E24] ">150</p>
                                <p class="text-[25px]">GB</p>
                        ...
                        <div class="bg-white p-4 flex flex-col gap-5">
                            ...
                            <p class="text-start font-[700] text-[1rem]">เริ่ม 11 ต.ค. 66 - 31 ต.ค. 66</p>
                        </div>
        ...
        <section class="bg-[#F8F9FA] py-6">
            ...
            <div class=" my-16 w-full">
                <div class="max-w-[1536px] my-0 mx-auto grid grid-cols-3 gap-10 ">

                    <div class="drop-shadow-md w-[100%]  ">
                        <div class=" bg-gradient-to-r from-[#F6911D] to-[#ED4312] rounded-tl-[10px] rounded-tr-[10px] py-2">
                            {{-- <div class="flex justify-start items-center"> --}}
                            <p class="text-white text-left ml-3 text-[16px]">ซิมเทพ เล่นเน็ตไม่อั้น ใช้ได้ไม่จำกัด</p>
        ...
        <section class="bg-[#ffff] py-6">
            ...
            <div class="max-w-[1536px] my-0 mx-auto   ">
                ...
                <div class=" grid grid-cols-2 gap-5 r">
