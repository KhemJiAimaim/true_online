<div class=" bg-gradient-to-r from-[#F6911D] to-[#ED4312] mt-auto overflow-hidden relative">
    ...
    <div class="p-6 flex justify-center gap-[6rem] 2xl:gap-[15rem] ">
        <a href="https://line.me/ti/p/~@berhoro" class="flex flex-col items-center">
        ...
        <a href="{{ url('/delivery') }}" class="flex flex-col items-center">
