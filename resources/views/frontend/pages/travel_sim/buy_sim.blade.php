...
@section('content')
    <div class="mt-16">
        <div class=" flex justify-center items-center">
            <div class="w-[1536px] max-2xl:max-w-[90%] grid grid-cols-1 lg:grid-cols-3 2xl:grid-cols-3  gap-4 m-3">
                ...
                <div class="bg-white w-full 2xl:h-[590px]  items-center px-4 lg:px-1 mb-6 relative">
                    ...
                    <div id="slide-wrapper" class="flex justify-start items-center ">


                        <img id="slideLeft" class="arrow absolute left-0 cursor-pointer  hover:scale-125"
                            src="/images/prev.png">
                        ...
                        <img id="slideRight" class="arrow absolute right-0 cursor-pointer hover:scale-125"
                            src="/images/next.png">
                ...
                <div class="col-span-2 space-y-10 text-left m-3">
                    <p class=" font-medium 2xl:text-2xl text-xl ">(เล่นฟรีเดือนแรก) ซิมเทพ True เล่นเน็ตไม่อั้น ความเร็ว
                        4Mbps
                        (พร้อมใช้ฟรี
                        True wifi max
                        speed แบบไม่จำกัด)</p>

                    <div class="flex justify-center border-l border border-gray-500 text-center  rounded-full px-auto">
                    </div>
                    ...
                    <div
                        ...
                        @for ($i = 1; $i <= 1; $i++)
                            <div id="box{{ $i }}"
                                ...
                                <div class="flex ">
                                    <img src="/images/travel/Rectangle 1281 (1).png" alt="" class="w-16">
                                    <p class="text-[20px]  font-medium ml-2">ซิมปกติ (Physical
                                        SIM)</p>
                                </div>
                                <div class="flex items-center mt-2">
                                    <img src="/images/check-one.png" alt="" class="check-box w-10">
                                    <p class="text-xl 2xl:text-[2rem] font-bold ml-10 text-red-600">449 </p>
                                    <p class="text-[22px] font-medium ml-2 ">บาท</p>
                                </div>
                            </div>
                        @endfor
                    </div>
        ...
        {{-- box package --}}
        <div class="max-w-[1536px] max-2xl:max-w-[80%] pt-10 mx-auto mb-6 mt-6">
            <div class="">
                <div class="flex">
                    <button id="btn-package"
                        class="py-2 px-4 text-white bg-gradient-to-r from-[#F6911D] to-[#ED4312] rounded-t-[10px] text-[18px]">รายละเอียด
                        แพ็กเกจ</button>
                    <button id="btn-condition" class="py-2 px-6 text-white bg-[#838383] rounded-t-[10px] text-[18px]">เงื่อนไข</button>
                </div>
                {{-- content detail --}}
                <div id="box-package"
                    ...
                    <div class="w-full lg:w-[400px] ml-3 text-left">
                        <p class="text-[18px] font-medium mt-3">ซิมเทพ เล่นเน็ตไม่อั้น +โทรฟรีทุกค่าย ลูกค้าจะได้เล่นเน็ตไม่จำกัด ฟรีเดือนแรก โปรโมชั่นเครือข่าย
                            True
                        </p>
                ...
                <div id="box-condition" 
                    class="hidden bg-[#F8F9FA] text-left min-h-[200px] p-2 border-solid border-2 border-[#ED4312] text-[18px] font-medium mt-3 rounded-r-[10px] rounded-bl-[10px]">
...
@section('scripts')
    @vite('resources/js/travel/detail_ber.js')
@endsection
