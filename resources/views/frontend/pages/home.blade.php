...
@section('content')
    <div class="2xl:my-12">
        ...
        @php 
            ...
            $j++;
        @endphp
        <section id="{{$cate->cate_url}}" class="{{$bg}} py-6 relative z-0 px-3">
            {!!$circle1!!}
            <p class="text-[#000] mt-2 mb-2 2xl:text-[2rem]  xl:text-[22px] text-[20px] font-medium">{{$cate->cate_title}}</p>
                ...
                <div class="2xl:w-[1536px] lg:w-[1350px] xl:w-[1200px] w-[1400px] dm:w[1380px] grid grid-cols-4 xl:gap-3 2xl:gap-6 gap-4 dm:gap-8 ss:gap-4 mx-auto ss:p-1 p-4">
                    ...
                    @if($cate->id == 2)
                        @foreach ($product_fiber as $fiber)
                            <div class="drop-shadow-md overflow-hidden py-2">
                            ...
                            <div class="drop-shadow-md overflow-hidden py-2">
                                <div
                                    ...
                                    <div class="flex justify-start items-center gap-1 ">
                                        ...
                                        <p class="text-white font-medium text-[1.5rem]">{{$ber->product_grade}}</p>
                                    </div>
                                    <div
                                        ...
                                        <p class="text-white font-bold text-[1.5rem]">{{$ber->product_sumber}}</p>
                                    </div>
                                ...
                                <div class="bg-white">
                                    <div class="flex justify-center py-10 ">
                                        <p class="2xl:text-[2.5rem] text-[2rem] text-center font-bold">{{$ber->product_phone}}</p>
                                    </div>
                                </div>

                                <div class="bg-[#F8F9FA] grid grid-cols-5 py-2 h-[100px] ">
                                    <img src="/images/Ellipse 6.png" alt="" class="px-4">
                                    <p class="text-left 2xl:text-[16px] text-[14px] p-2 py-1 col-span-4 ">{{$ber->product_comment}}</p>
                                </div>
                                ...
                                <div
                                    ...
                                    <div class="grid grid-cols-3 items-center">
                                        <p class="text-white text-left 2xl:text-[18px] text-[16px]">ราคา</p>
                                        <p class="text-white font-medium text-center 2xl:text-3xl md:text-[2rem]  text-2xl">{{number_format($ber->product_price)}}</p>
                            ...
                            <div class="drop-shadow-md overflow-hidden py-2">
                                ...
                                <div class=" relative bg-gradient-to-r from-[#ED4312] to-[#F6911D] py-3 px-2 items-center">
                                    <img class=" absolute left-0 bottom-0" src="/images/circle/Intersect (2).png"
                                        alt="">
                                    <div class="grid grid-cols-3 items-center">
                                        <p class="text-white text-left 2xl:text-[18px] text-[16px] ">ราคา <br>
                                            เริ่มต้น</p>
                                        <p
                                            class="text-white font-medium text-center 2xl:text-3xl md:text-[2rem] pt-3 text-2xl">
                                            150</p>
                                        <p class="text-white text-right text-[1rem] 2xl:text-[16px]">บาท <br>
                                            /เดือน</p>
                                ...
                                <div
                                    ...
                                    <a href="#"
                                        class="cursor-pointer py-2  px-6 mb-2 mt-2 2xl:text-[16px] text-[16px] font-medium text-red-500 focus:outline-none bg-white rounded-full border border-red-500 hover:bg-red-500 hover:text-white">รายละเอียด</a>
                                    <a href="#"
            ...
            <div class="items-center mx-auto mt-4 pt-6">
                <a href="{{url('/'.$cate->cate_redirect)}}" class="py-2.5 px-5 mb-2 mt-2 2xl:text-[16px] md:text-[16px] text-[1rem] font-medium text-red-500 focus:outline-none bg-white rounded-full border border-red-500 hover:bg-red-500 hover:text-white">ดูทั้งหมด</a>
            </div>
            {!!$circle2!!}
        </section>
        @endforeach
