...
@section('content')
    <div class="py-12 flex justify-center items-center">
        <div class="w-[1536px] grid grid-cols-1 lg:grid-cols-3 2xl:grid-cols-3  gap-4 m-3">

            <div class="bg-white w-full h-[590px] items-center px-4 mb-10">
                <img id="featured" src="/images/Rectangle 1281.png" alt="" class="w-full h-[500px]  cursor-pointer mb-2">
                <div class="flex justify-center  items-center gap-4 overflow-x-hidden">
                    
                    @for ($i = 1; $i <= 4; $i++) 
                    <img src="/images/Rectangle 1281.png" alt="" class="thumnail w-[120px] h-[100px] cursor-pointer rounded-lg opacity-50 hover:opacity-100">
                    @endfor
                </div>
            </div>

            <div class="col-span-2 space-y-10 text-left m-3">
                <p class=" font-medium text-2xl ">(เล่นฟรีเดือนแรก) ซิมเทพ True เล่นเน็ตไม่อั้น ความเร็ว 4Mbps
                    (พร้อมใช้ฟรี
                    True wifi max
                    speed แบบไม่จำกัด)</p>
    ...
    {{-- box package --}}
    <div class="max-w-[1536px] max-2xl:max-w-[80%] pt-10 mx-auto mb-6">
        <div class="">
            <div class="flex">
            ...
            {{-- content detail --}}
            <div id="box-package"
                class="p-4 border-solid border-2 border-[#ED4312] rounded-r-[10px] rounded-bl-[10px] w-full h-full 2xl:h-[450px] text-left">
                <div class="w-full 2xl:w-[450px] ml-3">
                    <p>ซิมเทพ เล่นเน็ตไม่อั้น +โทรฟรีทุกค่าย ลูกค้าจะได้เล่นเน็ตไม่จำกัด ฟรีเดือนแรก โปรโมชั่นเครือข่าย True
                    </p>
                    ...
                    <p>4. True ความเร็ว 15Mbps + เล่นเน็ตไม่อั้น 55GB (FUP 1Mbps) "ฟรีเดือนแรก" เดือนต่อไป เติมเงิน 250 บาท
                        (รวมภาษีแล้ว)</p>
                    <p>5. True ความเร็ว 15Mbps +โทรฟรีทุกค่าย เล่นเน็ตไม่อั้น 30GB (FUP 384Kbps) "ฟรีเดือนแรก" เดือนต่อไป
            ...
            <div id="box-condition"
                class="hidden p-4 border-solid border-2 border-[#ED4312] rounded-r-[10px] rounded-bl-[10px] w-full h-full 2xl:h-[450px]">
                <div class="w-[450px] ">
    ...
    <div class="bg-white drop-shadow-md items-center w-full">
        <div class="flex 2xl:justify-center items-center gap-4 py-6 w-full flex-wrap ">
