    ...
    <div class=" mt-[120px] max-xl:mt-[74px]">
        <div class=" flex justify-center items-center">
                ...
                <div class="bg-white w-full 2xl:h-[500px]  items-center px-4 lg:px-1 mb-6 relative">
                    ...
                    <div id="slide-wrapper" class="flex  items-center">
                        ...
                        <div id="slider" class="flex gap-4 overflow-x-hidden mx-4 ">
                            <img src="/{{$prepaid_cate->thumbnail_link}}" alt="" class="thumnail active w-[100px] h-[100px] cursor-pointer rounded-lg opacity-50 hover:opacity-100 ">
         ...
         <div class="w-[1536px] max-2xl:max-w-[90%] pt-6 mx-auto mb-6">
            <div class="">
                <div class="flex">
                    <button id="btn-package" class="py-2 px-4 text-white bg-gradient-to-r from-[#F6911D] to-[#ED4312] rounded-t-[10px] text-[16px]">รายละเอียด แพ็กเกจ</button>
                ...
                {{-- content condition --}}
                <div id="box-condition" class="hidden bg-[#F8F9FA] text-left min-h-[200px] p-2 border-solid border-2 border-[#ED4312] text-[16px] font-medium rounded-r-[10px] rounded-bl-[10px]">
