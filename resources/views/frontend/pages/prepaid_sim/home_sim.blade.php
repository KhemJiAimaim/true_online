...
@section('content')
    <div class="2xl:mt-16 mt-[1rem]">
         ...
         <div class="title-plate-container pt-4 px-3">
            ...
            <div class="plate-group">
                ...
                <div class="title-plate-textboxC">
                    <p class="plate-text 2xl:text-[1.5rem] md:text-[20px]  text-[18px]">ทรู ซิมเติมเงิน และ แพ็กเกจเสริม ทั้งเน็ตและโทร</p>
                </div>
                        ...
                        <div class="drop-shadow-md">
                            ...
                            <div class="bg-white"">
                                <div class="flex justify-center py-4 ">
                                    <img src="/images/Rectangle 98.png" alt="" class="max-ex:w-[120px] max-ex:h-[120px]">
                                </div>
                            </div>
        ...
        <section id="sim" class="bg-white  py-6 px-3">
            <div class="">
                <p class="text-[#000] mt-2 mb-2 2xl:text-[2rem] xl:text-[22px] text-[20px] font-medium">แพ็กเกจเสริม</p>
