                ...
                @if ($cate->id == 17)
                    <div class="2xl:my-16 my-4 z-2 w-full">
                        <div class="max-w-[1548px] my-0 mx-auto flex justify-center ">
                            ...
                            <div class="swiper swiper1  items-center mx-auto w-full">
                                @php
                                            ...
                                            <div class="swiper-slide flex justify-center items-center ">
                                                <div class="drop-shadow-md w-[350px] ss:w-[340px] h-[100%]">
                                                    <div
                                                        ...
                                                        <p class="text-white text-left ml-3 text-[16px]">
                                                            {{ $prepaid->title }}</p>
                                                    ...
                                                    <div class="bg-[#F8F9FA] grid grid-cols-5 py-2  h-[100px]">
                                                        ...
                                                        <p
                                                            class="text-left 2xl:text-[16px] text-[14px] p-2  py-1 col-span-4">
                                                            {{ $prepaid->details }}</p>
                                                    </div>
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="grid grid-cols-3">
                                                            <p class="text-white text-left text-[16px] ">ราคา <br> เริ่มต้น
                                                            </p>
                                                            <p
                ...
                @else
                    <div class="2xl:my-16 my-4 z-2 w-full">
                        <div class="max-w-[1548px] my-0 mx-auto flex justify-center ">
                            ...
                            <div class="swiper swiper2  items-center mx-auto w-full">
                                @php
                                    $justify = 'justify-center max-xs:justify-start';
                                    if (count($package) > 3) {
                                        $justify = 'justify-start';
