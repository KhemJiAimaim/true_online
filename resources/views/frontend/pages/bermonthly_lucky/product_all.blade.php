                ...
                <div class="w-full max-xl:max-w-[54%] max-lg:max-w-full">
                    ...
                    <div class="mt-4 flex flex-col">
                        ...
                        <div class="flex gap-2">
                            <input class="w-6 h-7 bg-white border border-[#838383] text-center rounded-[3px]" type="text"
                                data-position="0" value="0" readonly>
                            <input class="w-6 h-7 bg-white border border-[#838383] text-center rounded-[3px]" type="text"
                                id="search-num" data-position="1" maxlength="1" placeholder="-">
                            <input class="w-6 h-7 mr-4 bg-white border border-[#838383] text-center rounded-[3px]"
                                type="text" id="search-num" data-position="2" maxlength="1" placeholder="-">
                            <input class="w-6 h-7 bg-white border border-[#838383] text-center rounded-[3px]" type="text"
                                id="search-num" data-position="3" maxlength="1" placeholder="-">
                            <input class="w-6 h-7 bg-white border border-[#838383] text-center rounded-[3px]" type="text"
                                id="search-num" data-position="4" maxlength="1" placeholder="-">
                            <input class="w-6 h-7 mr-4 bg-white border border-[#838383] text-center rounded-[3px]"
                                type="text" id="search-num" data-position="5" maxlength="1" placeholder="-">
                            <input class="w-6 h-7 bg-white border border-[#838383] text-center rounded-[3px]" type="text"
                                data-positionid="search-num"="6 h-7" maxlength="1" placeholder="-">
                            <input class="w-6 h-7 bg-white border border-[#838383] text-center rounded-[3px]"
                                type="text" id="search-num" data-position="7" maxlength="1" placeholder="-">
                            <input class="w-6 h-7 bg-white border border-[#838383] text-center rounded-[3px]"
                                type="text" id="search-num" data-position="8" maxlength="1" placeholder="-">
                            <input class="w-6 h-7 bg-white border border-[#838383] text-center rounded-[3px]"
                                type="text" id="search-num" data-position="9" maxlength="1" placeholder="-">
                        </div>
                    </div>
                    ...
                    <div class="mt-4 flex justify-between gap-4 max-xs:grid max-xs:grid-cols-2">
                        <div class="flex flex-col">
                            ...
                            <select class="w-36 max-lg:w-44 h-7 border border-[#838383] rounded-[3px]" name="slc-sum"
                                id="slc-sum">
                        ...
                        <div class="flex flex-col">
                            ...
                            <input
                                class="w-80 max-xl:w-48 max-lg:w-80 max-xs:w-full h-7 border border-[#838383] rounded-[3px]"
                                type="text" name="txt_favorite" id="txt_favorite">
                        </div>
                    </div>
                    ...
                    <div class="mt-4 flex justify-between gap-4 max-xs:grid max-xs:grid-cols-2">
                        <div class="flex flex-col">
                            ...
                            <select class="w-52 max-xl:w-36 max-lg:w-44 h-7 border border-[#838383] rounded-[3px]"
                        ...
                        <div class="flex flex-col max-xs:col-span-2">
                            ...
                            <div class="flex gap-4 w-80 max-xl:w-48 max-lg:w-80 max-xs:w-full">
                                <input class="w-full h-7 border border-[#838383] rounded-[3px] price-input" type="text"
                                    name="price-low" id="price-low">
                                <input class="w-full h-7 border border-[#838383] rounded-[3px] price-input" type="text"
                                    name="price-hight" id="price-hight">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex max-xl:flex-col max-xl:gap-4 justify-between mt-4">
                        <div class="flex flex-col">
                            ...
                            <div class="flex gap-1 text-white">
                                <button
                                    class="w-6 h-7 bg-gradient-to-r from-[#5741CD] to-[#00ACEE] rounded-[3px]">0</button>
                        ...
                        <div class="flex flex-col">
                            ...
                            <div class="flex gap-1 text-white">
                                <button
                                    class="w-6 h-7 bg-gradient-to-r from-[#EC1F25] to-[#960004] rounded-[3px]">0</button>
                                <button class="w-6 h-7 bg-[#838383] rounded-[3px]">1</button>
                                <button class="w-6 h-7 bg-[#838383] rounded-[3px]">2</button>
                                <button class="w-6 h-7 bg-[#838383] rounded-[3px]">3</button>
                                <button class="w-6 h-7 bg-[#838383] rounded-[3px]">4</button>
                ...
                <div class="w-full flex flex-col justify-between">
                        ...
                        <div class="flex flex-wrap gap-3">
                            <button class="relative p-2 bg-gradient-to-r from-[#EC1F25] to-[#960004] rounded-[5px] group">
                                <img style="filter: invert(96%) sepia(100%) saturate(12%) hue-rotate(237deg) brightness(200%) contrast(103%);"
                                    src="/icons/category/icon-money.png" alt="">
                    ...
                    <div class="flex flex-col">
                        ...
                        <div class="flex flex-wrap gap-3">
                            <button class="relative p-2 bg-gradient-to-r from-[#EC1F25] to-[#960004] rounded-[5px] group">
                                <img style="filter: invert(96%) sepia(100%) saturate(12%) hue-rotate(237deg) brightness(200%) contrast(103%);"
                                    src="/icons/category/icon-swarn.png" alt="">
                                <div class="w-10 h-10 absolute -top-6 left-3 hidden group-hover:block">
                                    <img class="scale-150" src="/icons/category/union.png" alt="">
                                    <p class="w-full text-xs absolute top-0 left-0 text-center">การงาน</p>
                                </div>
