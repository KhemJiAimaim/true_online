    ...
    <div class=" text-left ">
        ...
        <div class="max-xs:mx-2">
            <div
                ...
                <div class=" bg-[#F8F9FA]  2xl:p-6 p-4 text-[17px] " style="border-radius: 12px;">
                                    ...
                                    <div class="flex gap-x-5 max-2xl:gap-x-2 max-xs:gap-x-3  text-white justify-between">
                                        @for ($i = 0; $i <= 9; $i++)
                                            <button id="like" data-fav="{{ $i }}"
                                                class="w-10 h-10 max-xl:w-8 max-xl:h-8 max-lg:w-10 max-lg:h-10 max-xs:w-7 max-xs:h-7 bg-[#838383] rounded-[3px] border-2 border-white {{ in_array(strval($i), $explodeLike) ? 'bg-gradient-to-r from-[#5741CD] to-[#00ACEE] selected' : '' }} hover:bg-gradient-to-r from-[#5741CD] to-[#00ACEE]">
                                                {{ $i }}
                                            </button>
                                        @endfor
                                    </div>
                                    ...
                                    <div class="flex gap-x-5 max-2xl:gap-x-2 max-xs:gap-x-3 text-white justify-between w-full">
                                        @for ($i = 0; $i <= 9; $i++)
                                            <button id="dislike" data-fav="{{ $i }}"
                                                class="w-10 h-10 max-xl:w-8 max-xl:h-8 max-lg:w-10 max-lg:h-10 max-xs:w-7 max-xs:h-7  bg-[#838383] rounded-[3px] border-2 border-white {{ in_array(strval($i), $explodedisLike) ? 'bg-gradient-to-r from-[#EC1F25] to-[#960004] selected' : '' }} hover:bg-gradient-to-r from-[#EC1F25] to-[#960004]">{{ $i }}</button>
                                        @endfor
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="w-full flex flex-col justify-between">
                                ...
                                <div class="flex flex-wrap gap-[1rem] max-xs:gap-[1rem] max-es:gap-[0.8rem]">
                                    ...
                                    @foreach ($berpredict_numbcate as $numbcate)
                                        ...
                                        <button id="improve-ber" data-id="{{ $numbcate->numbcate_id }}"
                                            class="relative p-[0.5rem] w-[80px] max-xl:w-[60px] bg-white rounded-[5px] border-2 border-white group {{ $imp_selected }} hover:bg-gradient-to-r from-[#EC1F25] to-[#960004]">
                                            <img src="{{ $numbcate->thumbnail }}" alt=""
                                                style="{{ $image_selected }}" class="group-hover:filter group-hover:invert group-hover:saturate-12 group-hover:hue-rotate-237 group-hover:brightness-0 group-hover:contrast-100">
                            ...
                            <div class="flex flex-col">
                                ...
                                <div class="flex flex-wrap gap-[1rem] max-xs:gap-[1rem] max-es:gap-[0.8rem]">
                                    @foreach ($berproduct_cates as $bercate)
                                        @if ($bercate->bercate_pin == true)
                                            ...
                                            <button id="cate-ber" data-id="{{ $bercate->bercate_id }}"
                                                class="relative p-[0.5rem] w-[80px] max-xl:w-[60px]  bg-white rounded-[5px] border-2 border-white group {{ $aus_selected }} hover:bg-gradient-to-r from-[#EC1F25] to-[#960004]">
                                                <img src="{{ $bercate->thumbnail }}" alt=""
                                                    style="{{ $img_selected }}" class="group-hover:filter group-hover:invert group-hover:saturate-12 group-hover:hue-rotate-237 group-hover:brightness-0 group-hover:contrast-100">
                                                <div
                                    ...
                                    class="relative p-2 w-[80px] max-xl:w-[60px] bg-white border-2 border-white rounded-[5px] group  {{ isset($_GET['pin']) ? 'bg-gradient-to-r from-[#EC1F25] to-[#960004] selected' : '' }} hover:bg-gradient-to-r from-[#EC1F25] to-[#960004] ">
